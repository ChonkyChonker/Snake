  ...
  public Game() {
        ...
        public void update(){
            if (graphics.state == "RUNNING"){
                if(check_food_collison()){
                    player.grow();
                    food.random_spawn(player);
                }
                else if(check_wall_collison() || check_self_collison()){
                    graphics.state = "END";
                }
                else{
                    player.move();
        ...
        private boolean check_wall_collison(){
        ...
        private boolean check_food_collison(){
        ...
        private boolean check_self_collison(){
        ...
        public void setJframe(JFrame window){
            this.window = window;
        }
}
